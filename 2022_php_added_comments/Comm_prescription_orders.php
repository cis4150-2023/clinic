...
//assigns the form inputs to php variables
...
// Getting patient info for prescription given patient id
//$patient_id = 1;
...
// Grabbing doctor name based on doctor_id or user_id
...
// Getting medication ID for drugname given drugname
...
// Getting pharmacy_id from pharmacy
$pharmacy_id = 0;
...
//this is the pdf that we saw from the demo, we may want to change it a bit, so here is a start
