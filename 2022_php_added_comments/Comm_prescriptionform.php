<form action="prescription_orders.php" method="post" target="prescriptionlinkdisplay" id="prescriptionform">
    <script type="text/javascript">
        function calcquantity(){
            //the above is utilizing a bit of javascript to do some calculations below
        ...
        <div id="patient_info">
            <?php 
                //#$orderprescription
                //gets the users id and patient's id
                ...
                //This below block gets the patient name and their respective date of birth
        ...
        <datalist id="pharmacy_list">
            <?php  
            //gets the pharmacy name and echo's it
        ...
        <fieldset id="prescription_inputs">
            ...
            <datalist id="druglist">
                <?php
                //gets the medication name and its generic name from the drug list, then sets up checkboxes and labels from the results                                
            ...
            <!-- the below is in HTML, it essentially lists the options that can be applied to every drug, such as dosage number, unit of dosage, dostage type, dosage route, quantity per dose, frequency of dose and duration of dose -->
            <!-- this is essentially the form populated given the drugs supplied in the form beforehand, this is where you assign everything about the drug necessary to help the patient -->
